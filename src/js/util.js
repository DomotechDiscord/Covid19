...
export function autoFill() {
  ...
  if(params.has("datesortie") == true) {
    document.getElementById("field-datesortie").value = params.get("datesortie");
  }

  if(params.has("heuresortie") == true) {
    document.getElementById("field-heuresortie").value = params.get("heuresortie");
  }
